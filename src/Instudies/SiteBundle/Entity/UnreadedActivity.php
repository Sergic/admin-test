 ...
 *
 * @ORM\Table(name="UnreadedActivity")
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Instudies\SiteBundle\Entity\UnreadedActivityRepository")
 */
class UnreadedActivity extends BaseTimestampableEntity
{
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="User", inversedBy="unreadedActivity")
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Activity", inversedBy="unreaded")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    protected $activity;
