 ...
 *
 * @ORM\Table(name="UnreadedEducationGroupBlogPost", indexes={@ORM\Index(name="user_blog_index", columns={"user_id", "educationGroupBlogPost_id"})})
 * @ORM\HasLifecycleCallbacks()
 * @ORM\Entity(repositoryClass="Instudies\SiteBundle\Entity\UnreadedEducationGroupBlogPostRepository")
 */
class UnreadedEducationGroupBlogPost extends BaseTimestampableEntity
{
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="User", inversedBy="unreadedEducationGroupBlogPost")
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="EducationGroupBlogPost", inversedBy="unreaded")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
